...
const Navbar = () => {
  ...
  return (
    <nav className=" fixed mx-auto border-b border-mycolor-300 top-0 left-0 right-0 z-10 bg-mycolor-400 bg-opacity-85">
      <div className="flex container lg:py-4 py-2 px-4 flex-wrap items-center justify-between">
        <Link
          href="/"
          className="text-3xl mf:text-4xl text-mycolor-700 font-semibold font-poppins"
        >
          Arif Emin Köklü
        </Link>
